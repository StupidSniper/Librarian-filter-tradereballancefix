...
public class NeoForgeTradeConfigScreen extends Screen {
    ...
    public NeoForgeTradeConfigScreen(boolean enableReroll, boolean enableEachLevelReroll, boolean disableTradeRebalance) {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Save"), button -> {
            ClientPacketDistributor.sendToServer(new TradeConfigUpdatePayload(this.enableReroll, this.enableEachLevelReroll, this.disableTradeRebalance));
            this.onClose();
