...
public class LibrarianfilterForge {
    public LibrarianfilterForge(IEventBus modEventBus) {
        TradeConfig.load();
        ...
        LibrarianfilterForgeClient.init(modEventBus);
    }
